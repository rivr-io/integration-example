...
public class HomeController : Controller
{
    ...
    private readonly string _platformId = "YOUR_ID_HERE";
    private readonly string _platformApiKey = "YOUR_API_KEY_HERE";
    private readonly string _merchantId = "YOUR_MERCHANTS_ID_HERE";
